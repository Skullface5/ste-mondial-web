...
insert into public.products
  (sku, name_fr, name_en, name_ar, desc_fr, desc_en, desc_ar, category, audience, price, old_price, image_url, stock, rating, review_count, featured, active)
values
  ('SM-INS-001', 'Oud Wood', 'Oud Wood', 'عود وود',
   ...
   'inspires', 'unisexe', 49.900, 65.000, NULL, 40, 5.0, 12, true, true),
  ...
  ('SM-INS-002', 'J''adore', 'J''adore', 'جادور',
   ...
   'inspires', 'femme', 49.900, 65.000, NULL, 35, 5.0, 8, true, true),
  ...
  ('SM-INS-003', 'Bleu de Chanel', 'Bleu de Chanel', 'بلو دي شانيل',
   ...
   'inspires', 'homme', 49.900, 65.000, NULL, 30, 5.0, 15, true, true),
  ...
  ('SM-INS-004', 'Bois de Santal', 'Sandalwood', 'خشب الصندل',
   ...
   'inspires', 'unisexe', 49.900, 65.000, NULL, 25, 4.9, 6, true, true),
  ...
  ('SM-VOI-001', 'Diffuseur Voiture Vanille', 'Vanilla Car Diffuser', 'معطر سيارة بالفانيليا',
   ...
   'voiture', 'unisexe', 8.000, null, NULL, 60, 4.8, 5, false, true),
  ...
  ('SM-AMB-001', 'Diffuseur d''Ambiance Pêche', 'Peach Ambiance Diffuser', 'معطر أجواء بالخوخ',
   ...
   'ambiance', 'unisexe', 18.000, null, NULL, 30, 4.9, 4, false, true),
  ...
  ('SM-MUS-001', 'Musc Blanc', 'White Musk', 'مسك أبيض',
   ...
   'musc', 'unisexe', 20.000, null, NULL, 25, 5.0, 9, false, true),
  ...
  ('SM-AMB-002', 'Air Fresh Cerise', 'Cherry Air Fresh', 'معطر كرز',
   ...
   'ambiance', 'unisexe', 40.000, null, NULL, 20, 4.8, 3, false, true)
